                    ...
                    <div class="container">
	                    ...
	                    <div class="row text-center">
	                        <div class="col-lg-8 col-lg-offset-2">
	                            ...
	                            <hr class="light">
	                            <p style="background-color: rgba(255,255,255,0.5); color: black; ">Votre avez décidé de payer votre pavé par chèque. <br />
	                            	Veuillez envoyez un chèque avec la somme de <?php echo $order["ord_amount"]; ?>&euro; en indiquant au dos 
	                            	le code &laquo;PAVE-<?php echo $order["ord_id"]; ?>&raquo;
	                            	à l'ordre du : &laquo; Parti Pirate &raquo;<br />
